 ...
 *		Version: 0.1   
 *		Class: BaoKimPayment
 *		Function: Integrate BaoKim Payment for merchant sites have API
 *					
 *		
 *		
 */
...
class BaoKimPayment 
{
	...
	// merchante site code 
	private $merchant_id = '173';	// BaoKim provide merchant ID when register new merchant site

	// merchante site password
	private $secure_pass = 'e6c6e69d0b76943b'; // BaoKim provide merchant ID when register new merchant site
	...
	public function verifyResponseUrl($_GET = array())
	{
		...
		// compare verification code from our site with verification code returned from baokim.vn
