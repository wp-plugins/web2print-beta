<?php
 ...
 Version: 1.0
 */
class openid_provider_technorati implements openid_iprovider
{
    //private $endpoint = 'http://technorati.com/people/technorati/%s/';
	private $endpoint = 'technorati.com/people/technorati/%s';
