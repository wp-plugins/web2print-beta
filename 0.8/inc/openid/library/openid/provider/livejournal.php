...
/*
 ...
 Version: 1.0
 */
class openid_provider_livejournal implements openid_iprovider
{
    private $endpoint = '%s.livejournal.com';
    //private $endpoint = 'http://www.livejournal.com/openid/server.bml';
